...
def procesar_argumentos():
    ...
    groupOpt.add_argument('-me','--modulo_esc', action='store', dest='modulo_esc', help='Módulo de escaneo a aplicar (ver disponibles con opción -lm)')
    groupOpt.add_argument('-mx','--modulo_ext', action='store', dest='modulo_ext', help='Módulo de extracción a aplicar al escaneo (ver disponibles con opción -lm)')
